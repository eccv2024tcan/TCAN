#### CUDA_VISIBLE_DEVICES=0 python inference_folders.py --from_root_dir /home/nas4_dataset/vision/TikTok/TikTok_dataset/valid/ --image_folder_name images
import argparse
